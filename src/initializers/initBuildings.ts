...
export const initBuildings = (onTick: () => void = () => {}) => {
  ...
  const e1_1_1 = new Elevator(6, 0, "Northern elevator", onTick);
  const e1_1_2 = new Elevator(6, 0, "Southern elevator", onTick);
  ...
  const e2_1_1 = new Elevator(5, 0, "Ambulance public elevator", onTick);
  const e2_1_2 = new Elevator(8, 0, "Ambulance personnel elevator", onTick);
  c2_1.connectElevator(e2_1_1);
  c2_1.connectElevator(e2_1_2);

  const c2_2 = new Controller(7, onTick);
  const e2_2_1 = new Elevator(5, 0, "Operating room lounge patients", onTick);
  const e2_2_2 = new Elevator(5, 0, "Operating room lounge cargo", onTick);
  const e2_2_3 = new Elevator(
    7,
    0,
    "Operating room lounge fire escape",
    onTick,
  );
